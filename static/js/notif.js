const diva           = document.querySelector(".notif-div");
const remicon        = document.querySelector(".remove"  );
...
// effect when hover on notif div

diva.onmouseenter=()=>{
  remicon.classList.remove("remove")
  remicon.classList.add("remove-js")
  return true

}
diva.onmouseleave=()=>{
  remicon.classList.remove("remove-js")
  remicon.classList.add("remove")
  return true
}

remicon.addEventListener("click",()=>{
  return diva.parentNode.removeChild(diva)
})
